...
import { createCharacters } from "../graphql/mutations";
export default function CharactersCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setClothes(initialValues.clothes);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "CharactersCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
